          ...
          <View style={styles.formCompleteBar}>
            <TouchableOpacity
              ...
              {generatingPDF
                ...
                : <Text style={styles.downloadBtnText}>Download Filled PDF</Text>}
            </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1}
          ...
          <View style={styles.bottomSheet}>
            ...
            {scamSheet.data && (() => {
              ...
              return (
                <>
                  <Text style={styles.scamSheetTitle}>Scam Shield Report</Text>
                  ...
                  {level === "HIGH" && (
                    <View style={styles.scamWarningBox}>
                      <Text style={styles.scamWarningText}>
                        Do NOT provide personal info or click any links.{'\n'}
...
const styles = StyleSheet.create({
  ...
  applyBanner:            { backgroundColor: '#e8f5e9', paddingHorizontal: 16, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#c8e6c9' },
