...
export const styles = StyleSheet.create({
  ...
  // ── Generic Input (For Form & Eligibility Screens) ────────────────────────
  inputContainer: {
    flexDirection: 'row',
    padding: 10,
    paddingBottom: Platform.OS === 'ios' ? 25 : 15, // ✅ Keeps it above the home bar!
    backgroundColor: '#ece5dd',
    alignItems: 'flex-end',
  },
  textInput: {
  ...
  sendButton: {
    backgroundColor: '#1565c0', // Overridden by inline styles if needed
    borderRadius: 20,
    paddingVertical: 12,
    paddingHorizontal: 20,
    marginLeft: 8,
