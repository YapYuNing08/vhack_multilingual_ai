...
async def transcribe_audio(
    ...
    print(f"[WHISPER] Received file: {file.filename}, size: {len(audio_bytes)} bytes, content_type: {file.content_type}")
    ...
    if "webm" in (file.content_type or "") or filename.endswith(".webm"):
        ...
        suffix = ".webm"  # default to webm (browser format)
    ...
    try:
        ...
        print(f"[WHISPER] Transcribed text  : '{text[:150]}'")
